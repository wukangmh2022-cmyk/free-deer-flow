...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    appearance: {
      themeTitle: "主题",
      themeDescription: "选择日间、夜间，或自动跟随系统。",
      colorThemeTitle: "配色主题",
      colorThemeDescription: "选择 DeerFlow 界面的整体配色风格。",
      warm: "暖黄",
      warmDescription: "保留当前偏暖、微黄的主视觉风格。",
      stone: "灰白",
      stoneDescription: "更克制的灰白配色。",
      blue: "蓝白",
      blueDescription: "以蓝色为强调色的清爽蓝白配色。",
      system: "系统",
      light: "日间",
      dark: "夜间",
      systemDescription: "自动跟随系统主题。",
      lightDescription: "明亮清晰的界面模式，适合白天使用。",
      darkDescription: "更柔和的暗色界面模式，减少眩光。",
      languageTitle: "语言",
